    ...
    <div className="container py-5">
      <header className="pb-3 mb-4 border-bottom">
        ...
        <p className="lead text-muted">
          Taller práctico: Gestión de estados y efectos en React + TypeScript (SENA ADSO)
        </p>
      </header>

      <div className="p-4 mb-4 bg-light rounded-3 border">
        <div className="container-fluid py-2">
          <h2 className="h4 fw-bold">Misión 0 — Entorno y Modelo de Datos Configurado</h2>
          <p className="col-md-10 fs-6 text-secondary">
            Estructura base del proyecto lista con Vite, React 19, TypeScript y Bootstrap 5.
          </p>
          ...
          <span className="badge bg-primary fs-6">Listo para iniciar Bloque 1</span>
        </div>
      </div>
    </div>
  );
